...
<head>
    ...
    <!-- END: Custom CSS-->
<style type="text/css">
    .multiloginsection .active{
            background-color: #7367f0 !important;
            border: 1px solid #7367f0;
    }

     .multiloginsection .inactive{
               border-color: #3f436f !important;
                background-color: #3f436f !important;
    }
</style>
</head>
<!-- END: Head-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <!-- <img src="<?=BASE_URL?>assets/images/logo.jpg" style="width: 70px;margin-top: -60px;object-fit: cover !important;"> -->
                            ...
                            <svg viewbox="0 0 139 95" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="24">
                                ...
                                <h2 class="card-title fw-bold mb-1" style="font-size: 20px;margin-top: 50px;">Welcome to E-Parkinggg</h2>
                                <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>
                                <form class="auth-login-form mt-2" action="login/login_user" method="POST">
                                    <div class="mb-1 field_error">
                                        <label class="form-label" for="login-email">Email</label>
                                        <input class="form-control" id="login-email" type="email" name="email" placeholder="example@test.com" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="mb-1">
                                        <!-- <div class="d-flex justify-content-between">
                                            <label class="form-label" for="login-password">Password</label><a href="#"><small>Forgot Password?</small></a>
                                        </div> -->
                                        <div class="input-group input-group-merge form-password-toggle field_error">
                                    ...
                                    <div class="mb-1 field_error brach_code" style="display: none;">
                                        <label class="form-label" for="branchcode">Branch Code</label>
                                        <input class="form-control" id="branchcode" type="text" name="bcode" placeholder="code" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <button type="submit" class="btn btn-primary w-100" tabindex="4">Sign in</button>
                                </form>
                                <div class="divider my-2">
                                    <div class="divider-text">Developed By</div>
                                </div>
                                 <p class="text-center mt-2"><span>Copyrights@E Parking. </span><a href="#"><span>&nbsp;All rights reserved.</span></a></p>
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
    ...
    <script type="text/javascript">
        $(document).on("click",".checklogintype",function(){
            var type = $(this).val();
            $(".removeclasssection").removeClass('active');
            $(".removeclasssection").removeClass('inactive');
            if(type == "admin"){
                $("#adminlabel").addClass('active');
                $("#branchlabel").addClass('inactive');
                $(".brach_code").hide();
            }else{
                  $("#adminlabel").addClass('inactive');
                $("#branchlabel").addClass('active');
                $(".brach_code").show();
            }
        });
    </script>
