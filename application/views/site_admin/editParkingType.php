...
<div class="app-content content ">
   ...
   <div class="card dt">
   <form class="form" action="<?php echo BASE_URL.'site_admin/edit_parking_type_entry/'.$parkinginfo->id.''?>" enctype="multipart/form-data" method="post">
            <span style="font-size: 15px;font-weight: bold;">Update Parking Type</span>
                          ...
                          <div class="col-xl-12 col-md-12 col-12 field_error">
                             <div class="mb-1">
                                <label class="form-label" for="accountname">Parking Type</label>
                                            <input type="text" name="parking_type_name" id="parking_type_name" value="<?= $parkinginfo->parking_type_name?>" class="form-control" placeholder="Enter parking type" required="" />
                             </div>
                          </div>
