...
<div class="app-content content ">
    ...
    <div class="card dt">
        <form class="form" action="<?php echo 'saveParking' ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                                ...
                                <div class="mb-1">
                                    ...
                                    <select class="form-control" name="parking_type">
                                        ...
                                        <?php foreach ($parking_type_master as $key => $value) { ?>
                                            ...
                                            <option value="<?php echo $value->id; ?>"><?php echo $value->parking_type_name; ?></option>
                            ...
                            <div class="col-xl-6 col-md-6 col-6 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="file" class="form-control" name="parking_image" required="" placeholder="Enter Parking name" />
                            ...
                            <div class="col-xl-6 col-md-6 col-6 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" name="name" required="" placeholder="Enter Parking name" />
                            ...
                            <div class="col-xl-6 col-md-6 col-6 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" name="parking_location" required="" placeholder="Enter Parking location" />
                            ...
                            <div class="col-xl-6 col-md-6 col-6 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" name="pincode" required="" placeholder="Enter Postcode" />
                            ...
                            <div class="col-xl-6 col-md-6 col-6 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" name="parking_slot" required="" placeholder="Enter Num of parking slots" />
                            ...
                            <div class="col-xl-2 col-md-2 col-2 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="checkbox" class="form-group" name="monday" placeholder="Enter Parking name" />
                            ...
                            <div class="col-xl-2 col-md-2 col-2 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="checkbox" class="form-group" name="tuesday" placeholder="Enter Parking name" />
                            ...
                            <div class="col-xl-2 col-md-2 col-2 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="checkbox" class="form-group" name="wednesday" placeholder="Enter Parking name" />
                            ...
                            <div class="col-xl-2 col-md-2 col-2 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="checkbox" class="form-group" name="thursday" placeholder="Enter Parking name" />
                            ...
                            <div class="col-xl-2 col-md-2 col-2 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="checkbox" class="form-group" name="friday" placeholder="Enter Parking name" />
                            ...
                            <div class="col-xl-2 col-md-2 col-2 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="checkbox" class="form-group" name="saturday" placeholder="Enter Parking name" />
                            ...
                            <div class="col-xl-12 col-md-12 col-12 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="checkbox" class="form-group" name="sunday" placeholder="Enter Parking name" />
                            ...
                            <div class="col-xl-6 col-md-6 col-6 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" name="price" required="" placeholder="Enter Parking price" />
                            ...
                            <div class="col-xl-6 col-md-6 col-6 field_error" style="float:left">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" name="vat" required="" placeholder="Enter VAT" />
