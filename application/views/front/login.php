  ...
  <div class="container">
    ...
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
      ...
      <div class="col-md-9 ftco-animate pb-5">
        ...
        <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo ('front'); ?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Login <i class="ion-ios-arrow-forward"></i></span></p>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="login_form_inner" style="    border: 1px solid lightgray;">
          ...
          <form class="row login_form" action="<?= base_url('front/checkLogin') ?>" method="post" id="contactForm" onsubmit="return validatePasswords();">

            <div class="col-md-12 form-group">

              <select class="form-control" id="options" name="options" style="border-top: unset;border-left: unset;border-right: unset;">
            ...
            <div class="col-md-12 form-group">
              ...
              <a class="createaccount" href="<?= base_url('front/register') ?>" style="color: #00aa56 ;    font-size: 13px;">DON'T HAVE AN ACCOUNT?</a>
