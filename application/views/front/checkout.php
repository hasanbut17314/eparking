  ...
  <div class="container">
    ...
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
      ...
      <div class="col-md-9 ftco-animate pb-5">
        ...
        <p class="breadcrumbs"><span class="mr-2"><a href="/eparking">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Checkout <i class="ion-ios-arrow-forward"></i></span></p>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-md-12 col-xl-12 setting_block" style="text-align: center;">
                  <div class="col-md-12 setting_sub_block" style="padding-left: 0px;padding-right: 0px;padding-bottom: 0;">
                    <div style="margin-bottom: 10px;">
                      ...
                      <span class="dateSpan" style="text-align: right;"><?= $orderData->parking_date . ' ' . $orderData->parking_start_time  ?></span>
                    </div>
