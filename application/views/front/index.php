		          		...
		          		<h2 style="color: #1f1f1f;">Find Your Parking</h2>
			    				<div class="form-group">
									...
									<!-- <select class="form-control">
										<?php 
											foreach ($parking_type_master as $key => $value) { ?>
										<option value="<?= $value->id;?>"><?= $value->parking_type_name;?></option>		
									<?php		}
										?>
										
									</select> -->
			    					<!-- <input type="text" class="form-control common_radius pickatime" name="location" id="location" placeholder="Where would you like to park?">
									<div class="append_location" style="position: absolute;background: lightgray;border: 1px solid lightgray;color: #000;z-index: 9999;padding: 10px;height: 180px;max-height: 200px;overflow-y: auto;overflow-x: hidden;">
										<span>Pennsylvania Lane, Tiptree, Colchester, CO5 0UE, United Kingdom</span>
										<span>Pennsylvania Lane, Tiptree, Colchester, CO5 0UE, United Kingdom</span>
									</div> -->
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('book_pick_dates').setAttribute('min', todayDate);
					  ...
					  <?php 
                            ...
                            ?>
		                <label for="" class="label" style="color: #1f1f1f;">Parking Start time (hh:mm AM/PM)</label>
		               
							<input type="text" name="parking_time" class="form-control common_radius" id="timeInput" placeholder="hh:mm AM/PM"  required>
							<span id="error-message" style="color: red; display: none;">Invalid time format. Please use hh:mm AM/PM.</span>
		              </div>
					  <div class="form-group">
					  <?php 
                                $timeOption = ['1' =>'8:00am','2' =>'9:00am','3' => '10:00am','4' => '11:00am','5' => '12:00pm','6' => '1:00pm','7' => '2:00pm','8' => '3:00pm','9' => '4:00pm','10' => '5:00pm','11' => '6:00pm','12' => '7:00pm','13' => '8:00pm','14' => '9:00pm','15' => '10:00pm','16' => '11:00pm'];
                            ?>
		                <label for="" class="label" style="color: #1f1f1f;">Parking End time (hh:mm AM/PM)</label>
		               
							<input type="text" name="parking_end_time" class="form-control common_radius" id="timeendInput" placeholder="hh:mm AM/PM"  required>
							<span id="error-message1" style="color: red; display: none;">Invalid time format. Please use hh:mm AM/PM.</span>
		              </div>
			            <div class="form-group">
...
<style>
    ...
    z-index: 9999;
    padding: 5px;
    width: 317px; /* Adjust width according to input field */
    max-height: 200px;
    overflow-y: auto; /* Scrollbar for Y-axis */
