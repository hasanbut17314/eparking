...
.profile_block, .append_order_details, .address_block {

    color: #3d4246 !important;

}

.profile_block_subsection, .order_block_subsection {
...
.profile-option, .order-option, .delivery-upload-option, .save-upload-option {
...
$("#editFeedback").modal('show');
   ...
   $(document).on("click", ".profile-option", function(){
    $(".profile-option").addClass('active-tab');
    $(".order-option").removeClass('active-tab');
       $('.profile_block').show();
      ...
      $(document).ready(function() {
        ...
        $(".profile-option").removeClass('active-tab');
        $(".order-option").addClass('active-tab');
